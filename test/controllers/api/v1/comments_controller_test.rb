...
class CommentsControllerTest < UltimateTestHelper
  def setup
    ...
    @params_create = {:category => "simple", :comment_from => 1, :user_id => 1, :content => "fun fun fun fun fun fun", :institution_id => 71, :authentication => session_create}
    @params_update = {:category => "athletic", :authentication => session_create}
    @model_type = :comment
    @id = 11
