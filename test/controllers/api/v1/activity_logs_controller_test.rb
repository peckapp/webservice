...
class ActivityLogsControllerTest < UltimateTestHelper
  def setup
    ...
    @params_create = {:institution_id => 3, :sender => 15, :receiver => 2, :category => "idk", :type_of_activity => "athletic", :message => "FUN FUN FUN", :read_status => false, :authentication => session_create}
    @params_update = {:message => "HEYYYYYYYYYYYYYYY", :authentication => session_create}
