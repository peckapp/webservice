...
class AthleticTeamsControllerTest < UltimateTestHelper
  def setup
    ...
    @params_create = {:institution_id => 2, :sport_name => "swimming", :gender => "male", :authentication => session_create}
    @params_update = {:sport_name => "rugby", :authentication => session_create}
