...
class NotificationViewsControllerTest < UltimateTestHelper
  def setup
    ...
    @params_create = {:user_id => 2, :activity_log_id => 3, :viewed => false, :institution_id => 1, :authentication => session_create}
    @params_update = {:viewed => true, :authentication => session_create}
