...
class SubscriptionsControllerTest < UltimateTestHelper
  def setup
    ...
    @params_create = {:institution_id => 1, :user_id => 5, :category => "physics", :subscribed_to => 3, :authentication => session_create}
    @params_update = {:category => "statistics", :authentication => session_create}
