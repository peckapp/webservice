...
class PecksControllerTest < UltimateTestHelper
  ...
  def setup
    ...
    @params_create = {:institution_id => 1, user_id: 1, :notification_type => "james", :message => "John invited you to the event 'Hello World' ", :send_push_notification => true, :invitation => "circle_invite", :circle_id => 1, :invited_by => 2}
