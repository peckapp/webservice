...
class MenuItemsControllerTest < UltimateTestHelper
  def setup
    ...
    @params_create = {name: "new menu item", institution_id: 1, dining_opportunity_id: 2, dining_place_id: 6, date_available: DateTime.current, :authentication => session_create}
    @params_update = {name: "updated menu item", :authentication => session_create}
