class SimpleEvent < ActiveRecord::Base
  ...
  has_attached_file :image, :url => "/images/simple_events/:id/:style/:basename.:extension", :path => ":rails_root/public/images/simple_events/:id/:style/:basename.:extension", :default_url => "/images/missing.png" #:styles => { :medium => "300x300>", :thumb => "100x100>" }
