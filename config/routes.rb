...
Rails.application.routes.draw do
  ...
  namespace :api, defaults: { format: 'json' }  do
    ...
    scope module: :v1, constraints: ApiConstraints.new(version: 1, default: true) do
      ...
      resources :simple_events, :activity_logs, :athletic_events, :athletic_teams, :clubs, :configurations, :departments, :dining_opportunities, :dining_periods, :dining_places,:event_attendees, :comments, :event_views, :events_page_urls, :institutions, :locations, :menu_items, :notification_views, :push_notifications, :simple_events, :subscriptions, :unique_device_identifiers, :explore, :announcements
