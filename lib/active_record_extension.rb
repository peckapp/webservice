...
module ActiveRecordExtension
  ...
  module ClassMethods
    ...
    def current_or_create_new(*attrs)
      fail "attempted to perform model interaction with inapplicable table: #{table_name} and superclass: #{superclass}" unless ancestors.include?(ActiveRecord::Base)
    ...
    def current_or_new(*attrs)
      fail "attempted to perform model interaction with inapplicable class: #{table_name} and superclass: #{superclass}" unless ancestors.include?(ActiveRecord::Base)
